...
def process_document_link_and_send(url, to_whatsapp):
    try:
        ...
        if len(final) < 2000:
            ...
            # try to split by double newlines + headings
            parts = []
            # naive split by double newline and send in parts
...
def whatsapp_webhook():
    ...
    if not incoming:
        resp.message("Hello, how are you? Do you have a file I can analyze for you? Please send me a link to a PDF or DOCX file.")
        return str(resp)
